...
INSERT INTO `sys_menu`(`menu_id`, `menu_name`, `parent_id`, `order_num`, `url`, `target`, `menu_type`, `visible`, `is_refresh`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (2043, '重命名明细', 2006, 1, '/openliststrm/renameDetail', '', 'C', '0', '1', 'openliststrm:renameDetail:view', '#', 'admin', '2025-09-30 11:14:57', '', NULL, '重命名明细菜单');
...
INSERT INTO `sys_menu`(`menu_id`, `menu_name`, `parent_id`, `order_num`, `url`, `target`, `menu_type`, `visible`, `is_refresh`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (2049, '重命名任务配置', 2006, 1, '/openliststrm/renameTask', '', 'C', '0', '1', 'openliststrm:renameTask:view', '#', 'admin', '2025-09-30 16:00:37', '', NULL, '重命名任务配置菜单');
