...
.file-info-box { display: flex; flex-direction: column; width: 100%; }
.file-name { font-size: 14px; color: #333; font-weight: 600; line-height: 1.4; margin-bottom: 4px; }
.file-path { color: #999; font-size: 11px; line-height: 1.2; font-family: Consolas, "Courier New", monospace; }
</style>
