    ...
    <div class="record-list">
      <div v-for="record in records" :key="record.recordId" class="record-card">
        ...
        <div class="record-body">
          <div class="record-meta">来源: {{ record.sourcePath }}</div>
          <div class="record-meta">目标: {{ record.targetPath }}</div>
        </div>
...
const records = ref([
  { recordId: 1, fileName: 'data.zip', status: '0', sourcePath: '/local/data.zip', targetPath: '/cloud/data.zip', updateTime: '2026-04-20 10:30' }
])
