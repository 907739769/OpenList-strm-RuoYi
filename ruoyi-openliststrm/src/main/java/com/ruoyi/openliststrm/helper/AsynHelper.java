                    ...
                    while (iterator.hasNext()) {
                        ...
                        if (200 == code && state != 2) {
                            ...
                            if (state == 7) {
                                ...
                                copyHelper.addCopy(copy);
                                iterator.remove();
                                tgHelper.sendMsg("*复制任务失败*\n" + "源目录：" + com.ruoyi.common.utils.StringUtils.escapeMarkdownV2(copy.getCopySrcPath()) + "\n" + "源文件名：" + com.ruoyi.common.utils.StringUtils.escapeMarkdownV2(copy.getCopySrcFileName()));
                            }
